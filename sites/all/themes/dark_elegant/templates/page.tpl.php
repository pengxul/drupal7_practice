...
<div id="page" class="container_6">
  <header id="header" role="banner">
    <div class=" clearfix">
      <div class="site-logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
        ...
        <img class="pull-right mt10-mr20" src="<?php print path_to_theme().'/images/tel.png'; ?>"  />
      </a></div>
    ...
    <nav id="navigation" role="navigation">
      <div id="main-menu">
        ...
        ?>
        <form action="<?php echo base_path().'product-page';?>" id="product_form">
          <label for="search">产品搜索:</label>
          <input id="search" type="text" name="title" value="">
          <input id="product_submit" type="submit"  value="确定">
        </form>
      </div>
    </nav>
  </header>
  ...
  <div id="foot_menu">
      <ul id="foot_menu_ul">
        <li><a href="<?php echo base_path().'/';?>" class="foot_menu_link">首页</a> | </li>
        <li><a href="<?php echo base_path().'/companys';?>" class="foot_menu_link">公司简介</a> | </li>
        <li><a href="<?php echo base_path().'/product-page';?>" class="foot_menu_link">产品中心</a> | </li>
        <li><a href="<?php echo base_path().'/node/57';?>" class="foot_menu_link">联系我们</a>  </li>
      </ul>
  </div>
